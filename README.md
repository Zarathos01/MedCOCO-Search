...
<div align="center">
| Authentication | Upload & My Uploads |
|----------------|---------------------|
...
| Component | Technology | Purpose |
|-----------|-----------|---------|
| Mobile & Desktop App | **Flutter (Dart)** | Cross-platform UI for mobile, desktop, and web |
...
# Get Flutter dependencies and run
flutter pub get
flutter run
```
 
> **Note:** Make sure the backend is running before launching the app. The frontend is a Flutter application — refer to the [Flutter documentation](https://docs.flutter.dev/get-started/install) for platform-specific setup.
